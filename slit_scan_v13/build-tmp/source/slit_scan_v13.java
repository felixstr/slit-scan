...
public class slit_scan_v13 extends PApplet {
...
public void updateDepth() {
 ...
 //   			}
	...
	for (int i=0;i<userList.length;i++) {
		if(context.getCoM(userList[i],com)) {
			...
			if (com.z > 0 && com.z < nearest) {
   				nearest = PApplet.parseInt(com.z);
   			}
		}
	}
    ...
    */
    ...
    if (nearest < maxDepth) {
    	depthPercent = PApplet.parseInt(map(nearest, minDepth, maxDepth, 100, 0));
...
public void onVisibleUser(SimpleOpenNI curContext, int userId)
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "slit_scan_v13" };
    if (passedArgs != null) {
